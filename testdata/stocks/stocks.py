...
"""
stocks.py
Download historical stock data for a list of tickers using yfinance, format, and save each to a separate CSV file.
"""
...
for ticker in tickers:
    ...
    if not stock_data.empty:
        ...
        print(f"Saved {file_path} ({len(stock_data)} rows)")
    else:
