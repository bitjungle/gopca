...
export function AnalyzeDataQuality(arg1:main.FileData):Promise<dataquality.DataQualityReport>;

export function AnalyzeMissingValues(arg1:main.FileData):Promise<dataquality.MissingValueStats>;
