...
import { useTheme, MarkdownRenderer } from '@gopca/ui-components';
        ...
        <div className="max-w-4xl mx-auto px-6 py-8 text-left">
          {isLoading ? (
            ...
            <MarkdownRenderer 
              ...
              className="prose-headings:text-gray-900 dark:prose-headings:text-gray-100 prose-headings:text-left
